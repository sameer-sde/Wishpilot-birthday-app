...
## 1️⃣ Install Python 3.10 or newer
...
⚠️ If you use Gmail, an App Password is usually required instead of your normal account password.
...
The app checks time every minute using Tkinter's event loop.

When the configured hour and minute match:
- 📧 birthday emails are sent
- 🎂 today's birthdays are detected
- ✅ duplicate emails are prevented using `last_sent_year`
